...
<body>
    <h1>Simple Javascript Obfuscator</h1>
    <p>Enter your JavaScript code below:</p>
    <textarea id="userScript" rows="10" cols="50"></textarea>
    <br>
    <button onclick="sendCode()">Obfuscate</button>
    <p>Result:</p>
    ...
    <script>
        function sendCode() {
            ...
            var data = 'JS_code=' + encodeURIComponent(userScript);
